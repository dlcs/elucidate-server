-- Function: public.annotation_creator_delete(integer, integer, integer)

-- DROP FUNCTION public.annotation_creator_delete(integer, integer, integer);

CREATE OR REPLACE FUNCTION public.annotation_creator_delete(
