...
public class OAAnnotationCollectionServiceImpl extends AbstractAnnotationCollectionServiceImpl<OAAnnotation, OAAnnotationPage, OAAnnotationCollection> implements OAAnnotationCollectionService {
    ...
    @Autowired
    public OAAnnotationCollectionServiceImpl(IRIBuilderService iriBuilderService, OAAnnotationPageService oaAnnotationPageService, AnnotationStoreRepository annotationRepository, AnnotationCollectionStoreRepository annotationCollectionRepository, @Value("${annotation.page.size}") int pageSize) {
        super(oaAnnotationPageService, annotationRepository, annotationCollectionRepository, pageSize);
