-- Function: public.annotation_text_quote_selector_delete(integer, integer)

-- DROP FUNCTION public.annotation_text_quote_selector_delete(integer, integer);

CREATE OR REPLACE FUNCTION public.annotation_text_quote_selector_delete(
    _bodyid integer,
    _targetid integer)
