-- View: public.annotation_text_position_selector_get

-- DROP VIEW public.annotation_text_position_selector_get;

CREATE OR REPLACE VIEW public.annotation_text_position_selector_get AS 
    SELECT
        asl.id,
        asl.selectoriri,
        ab.bodyiri,
    ...
    WHERE
        asl.type::text = 'http://www.w3.org/ns/oa#TextPositionSelector'::text;
